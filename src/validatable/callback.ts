...
>({
        ...
        validation,
        message
    } : Value<ValueType> & Guard<ValueType, Type> & Message<(result:Readonly<Value<ValueType> & Validatable<boolean>>)=> MessageType>
...
>({
        ...
        validation,
        message
    } : Value<ValueType> & Validation<[ValueType], boolean> & Message<(result:Readonly<Value<ValueType> & Validatable<boolean>>)=> MessageType>
) : Return<ValueType, ValueType, Type, Readonly<Value<ValueType> & Validatable & Message<MessageType>>>
