...
export declare function CallbackParameter<Base = unknown, Expectation extends Base = Base, MessageType = unknown>(validation: <Value extends Base>(argument: Value | Expectation) => argument is Expectation, message: Message.Parameters<Base, Expectation, MessageType>): Simple<Base, Expectation, Readonly<Validatable<Base, MessageType>>>;
export declare function CallbackParameter<Base = unknown, Expectation extends Base = Base, MessageType = unknown>(validation: <Argument extends Base>(argument: Base) => boolean, message: Message.Parameters<Base, Expectation, MessageType>): Simple<Base, Expectation, Readonly<Validatable<Base, MessageType>>>;
