...
export declare namespace Static {
    ...
    type Parameters<Allow = unknown, Argument extends Allow = Allow, Expectation extends Allow = Allow, Allowed extends boolean = boolean, Expected extends boolean = boolean, MessageType = unknown> = StaticParameters<Allow, Argument, Expectation, Allowed, Expected, MessageType>;
}
